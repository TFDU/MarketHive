...
public class ListAdapter extends RecyclerView.Adapter<ListAdapter.ListViewHolder>{
    ...
    public ListAdapter.ItemCallback itemCallback;

    public void setItemCallback(ListAdapter.ItemCallback itemCallback) {
    ...
    public void onBindViewHolder(@NonNull ListAdapter.ListViewHolder holder, int position) {
        ...
        if (product.imageUrls == null || product.imageUrls.length() == 0){ // TODO: image url from back-end can not be resolved as image
