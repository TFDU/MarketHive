...
public class SearchViewModel extends ViewModel {
    ...
    public LiveData<SearchResponse> searchProducts() {
        ...
        CustomLiveData input = new CustomLiveData(idToken, searchInput, categoryInput, locationInput, page, pageSize); // TODO: For real user
        ...
        public CustomLiveData(String userToken,
            ...
            addSource(searchInput, new Observer<String>() {
                ...
                public void onChanged(String s) {
                    setValue(new Cell(userToken, s, categoryInput.getValue(), locationInput.getValue(), page, pageSize));
                }
            });
        }
    }
